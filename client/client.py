...
def user_loop():
    ...
    while root and target:
        r = requests.get(api_arbitrary, params={
...
def main():
    parser = argparse.ArgumentParser(
        description='Either manually enter actors to find the degree of separation for, or feed in a list of API requests via a file.')
    parser.add_argument(
        '-f', '--file', help='File containing a Python dict representing server requests, one per line. See client_examples.data.')
